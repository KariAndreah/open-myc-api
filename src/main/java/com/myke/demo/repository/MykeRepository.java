...
public interface MykeRepository extends JpaRepository<Myke, Long> {
    ...
    Page<Myke> findByDayTime(@Param("day") String day, @Param("timeA") LocalTime start_timeA,
            @Param("timeB") LocalTime start_timeB, Pageable pageable);
    ...
    Page<Myke> findByDayTimeFree(@Param("day") String day, @Param("timeA") LocalTime start_timeA,
            @Param("timeB") LocalTime start_timeB, @Param("cost") Cost id, Pageable pageable);
    ...
    Page<Myke> findByBoroughDay(@Param("borough") List<String> borough, @Param("day") String day, Pageable pageable);
    ...
    Page<Myke> findByBoroughDayFree(@Param("borough") String borough, @Param("day") String day, @Param("cost") Cost id,
            Pageable pageable);
    ...
    Page<Myke> findByBoroughDayTime(@Param("borough") String borough, @Param("day") String day,
            @Param("timeA") LocalTime start_timeA, @Param("timeB") LocalTime start_timeB, Pageable pageable);
    ...
    Page<Myke> findByBoroughDayTimeFree(@Param("borough") String borough, @Param("day") String day,
            @Param("timeA") LocalTime start_timeA, @Param("timeB") LocalTime start_timeB, @Param("cost") Cost id,
            Pageable pageable);
    ...
    // Find By Borough and Day
    @Query("SELECT m FROM Myke m WHERE (m.day is NULL OR m.day LIKE %:day%) AND m.borough IN :borough")
    Page<Myke> findByBoroughsDay(@Param("borough") List<String> borough, @Param("day") String day, Pageable pageable);

    // Find By Borough and Day and Free
    @Query("SELECT m FROM Myke m WHERE (m.day is NULL OR m.day LIKE %:day%) AND m.borough IN :borough AND ( m.cost = :cost) ")
    Page<Myke> findByBoroughsDayFree(@Param("borough") List<String> borough, @Param("day") String day,
            @Param("cost") Cost id, Pageable pageable);

    // @Query("SELECT m FROM Myke m WHERE m.day LIKE %:day%")
    // List<Myke> findByDay(@Param("day") String day);

    // Find By Day and ID?? Unnecessary
    // @Query(value = "SELECT m FROM Myke m WHERE m.day LIKE %:day% AND m.id=:id",
    // nativeQuery = true)
    // List<Myke> findByDayAndId(@Param("day") String day, @Param("id") long id);

    // @Query(value = "SELECT m FROM Myke m WHERE m.day LIKE %:day% AND m.cost =
    // :cost")
