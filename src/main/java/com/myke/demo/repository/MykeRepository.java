...
public interface MykeRepository extends JpaRepository<Myke, Long> {
        ...
        Page<Myke> findByBoroughDay(@Param("borough") List<String> borough, @Param("day") String day,
                        Pageable pageable);
        ...
        Page<Myke> findByBoroughDayFree(@Param("borough") String borough, @Param("day") String day,
                        @Param("cost") Cost id,
                        Pageable pageable);
        ...
        Page<Myke> findByBoroughDayTime(@Param("borough") String borough, @Param("day") String day,
                        @Param("timeA") LocalTime start_timeA, @Param("timeB") LocalTime start_timeB,
                        Pageable pageable);
        ...
        Page<Myke> findByBoroughsDay(@Param("borough") List<String> borough, @Param("day") String day,
                        Pageable pageable);
